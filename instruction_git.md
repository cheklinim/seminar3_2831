...
## Скачивание всех изменений из удаленного репозитиория 

Чтобы "стянуть/ выкачать" все изменения из удаленного репозитория  на свой ПК нужно ввести команду:

    git pull

## Локальная копия удаленного репозитория 

Чтобы сделать локальную копию удаленного репозитория нужно ввести команду:
